...
const Button: React.FC<ButtonProps> = ({
  ...
  return (
    <div>
      <UIButton onClick={onClick} className={`${colors[color]} ${className} font-sans rounded-sm flex items-center justify-center gap-[10px] font-medium hover:bg-primary-800 transition ${sizes[size]}`}>
