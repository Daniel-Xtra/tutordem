  ...
  return (
    <>
      ...
      >
        {title && (
          <DialogHeader className="sticky bg-neutral-25 m-0 top-0 inset-x-0 flex flex-row justify-between items-center px-[24px] lg:px-[48px] py-[20px] lg:py-[60px]  h-[112px] border-b border-neutral-100">
            <div className="space-y-1 font-sans">
              <DialogTitle className="text-[28px] lg:text-[32px] font-semibold tracking-[-2px]">{title}</DialogTitle>
        ...
        <div className="px-6 sm:px-[60px] py-16 flex flex-col justify-center max-h-[600px] overflow-y-auto bg-white">
          {content}
        </div>
