...
const LayoutTextSlider = ({ slides }: { slides: SlidesInterface[] }) => {

    const [currentSlide, setCurrentSlide] = React.useState(0);
    const [currentBgImage, setCurrentBgImage] = React.useState(slides[0].image);
...
export default LayoutTextSlider;