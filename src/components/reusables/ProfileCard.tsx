      ...
      {showActionBtns && (
        <div>
          <div className="flex space-x-1">
            <Button
              type="button"
              className="border-none border-transparent md:border md:border-neutral-300 bg-primary-25 md:bg-transparent"
            >
              <FilePenLine
                color="#783bf9"
                className="w-[16px] h-[16px]  border-1 border-primary-500"
              />
              <span className="hidden md:block">Edit</span>
            </Button>
            <Button
              type="button"
              className="text-error-500 text-sm font-normal bg-error-25 md:bg-transparent"
            >
              <Trash2 color="#f04438" className="block md:hidden" />
