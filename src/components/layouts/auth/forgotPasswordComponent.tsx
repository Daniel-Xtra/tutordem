...
const ForgotPasswordComponent = () => {
    ...
    const handleClick = (e: React.MouseEvent<HTMLButtonElement>) => {
        e.preventDefault();
        router.push('/forgotpassword/verify-otp');
    }
    ...
    return (
        <div className="px-4">
            ...
            <p className="font-normal text-xs lg:text-sm mt-2">Enter your registered email address to receive <span className="text-neutral-950">OTP</span> </p>
            ...
            <form className="mt-8 flex flex-col mx-auto">
                ...
                <FormActionBtn actionText="Already have an account? " url="/" clickableText="Log in" className="py-10 block md:hidden absolute bottom-0 left-0 w-full px-4 border-t-[0.5px] border-t-neutral-200" onSubmit={handleClick}/>
            </form>
        </div>
    );
}
