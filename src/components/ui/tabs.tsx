...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "inline-flex flex-col items-start h-[63px] justify-start whitespace-nowrap rounded-[4px] border-[4px] border-neutral-100 px-[16px] py-[12px] data-[state=active]:text-neutral-950 text-neutral-950 font-normal text-sm transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
      className
    )}
    {...props}
  />
